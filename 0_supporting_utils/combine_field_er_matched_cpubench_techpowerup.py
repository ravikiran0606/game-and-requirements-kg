...
if __name__ == '__main__':
    st = time.time()
    file_write = jsonlines.open('er_cpu_benchmark_techpowerup_all_fields.jl', 'w')
    with jsonlines.open('er_techpowerup_cpu_benchmark.jl') as er_reader:
        for i, er_obj in enumerate(er_reader):
            ...
            with jsonlines.open('techpowerup_cpu.jl') as tech_reader:
            ...
            if er_cpubenchmark_key != '':
                with jsonlines.open('cpubenchmark.jl') as cpu_reader:
